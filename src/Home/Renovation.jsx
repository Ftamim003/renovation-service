        ...
        <div className="w-full h-[426px] bg-[linear-gradient(to_left,_rgba(148,148,148,1),_rgba(8,6,5,1))]">
            <div className='flex justify-center p-16 gap-5'>
                <div className='flex gap-5'>
                    <img className='w-[402px] h-[306px] rounded-lg' src="/Images/kitchen-renovation.jpg" alt="" />
                    <div>
                ...
                <div className='flex gap-3 '>
                    <img className='w-[402px] h-[306px] rounded-lg' src="/Images/bathroom-renovation.jpg" alt="" />
                    <div >
